...
@unittest.skip
class TestCaseBalanceLearning(TestCase):
    data: pd.DataFrame
    ...
    def test_learning_generative(self):
        model = JPT(infer_from_dataframe(self.data, scale_numeric_types=False), min_samples_leaf=0.334,
                    balance_variable_types=True)
        model.fit(self.data)
