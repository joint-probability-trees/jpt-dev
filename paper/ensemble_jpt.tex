...
(\texttt{paper/results.json}) ship with the paper.
...
\addplot[cJPT, thick, mark=*, mark size=1.5pt] coordinates {@@E3IRISTRAIN@@};
\addplot[cBoost, thick, mark=square*, mark size=1.5pt] coordinates {@@E3IRISTEST@@};
...
\addplot[cJPT, thick, mark=*, mark size=1.5pt] coordinates {@@E3DIABTRAIN@@};
\addplot[cBoost, thick, mark=square*, mark size=1.5pt] coordinates {@@E3DIABTEST@@};
\legend{train, held-out}
\end{axis}
\end{tikzpicture}
...
\addplot[cForest, thick, mark=*, mark size=1.5pt] coordinates {@@E2WINELL@@};
\addplot[cJPT, thick, dashed, mark=square*, mark size=1.5pt] coordinates {@@E2DIABLL@@};
...
\addplot[cForest, thick, mark=*, mark size=1.5pt] coordinates {@@E2WINEACC@@};
\addplot[cJPT, thick, dashed, mark=square*, mark size=1.5pt] coordinates {@@E2DIABR2@@};
...
Figure~\ref{fig:sweep} varies the forest size. @@E2PROSE@@
...
Table~\ref{tab:pred} places all six models side by side.
@@PREDPROSE@@
